...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.createEvent = createEvent;\nexports.updateEvent = updateEvent;\nexports.getEvent = getEvent;\nexports.getEventsList = getEventsList;\nexports.deleteEvent = deleteEvent;\n\nvar _httpStatus = __webpack_require__(/*! http-status */ \"http-status\");\n\nvar _httpStatus2 = _interopRequireDefault(_httpStatus);\n\nvar _event = __webpack_require__(/*! ./event.model */ \"./src/modules/events/event.model.js\");\n\nvar _event2 = _interopRequireDefault(_event);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nasync function createEvent(req, res) {\n  try {\n    const article = await _event2.default.createEvent(req.body, req.user._id);\n    return res.status(_httpStatus2.default.CREATED).json(article);\n  } catch (e) {\n    return res.status(_httpStatus2.default.BAD_REQUEST).json(e);\n  }\n}\n\nasync function updateEvent(req, res) {\n  try {\n    const event = await _event2.default.findById(req.params.id);\n    if (!event.user.equals(req.user.id)) {\n      return res.sendStatus(_httpStatus2.default.UNAUTHORIZED);\n    }\n    Object.keys(req.body).forEach(key => {\n      event[key] = req.body[key];\n    });\n    return res.status(_httpStatus2.default.OK).json((await event.save()));\n  } catch (e) {\n    return res.status(_httpStatus2.default.BAD_REQUEST).json(e);\n  }\n}\n\nasync function getEvent(req, res) {\n  try {\n    const event = await _event2.default.findById(req.params.id).populate('user');\n    return res.status(_httpStatus2.default.OK).json(event);\n  } catch (e) {\n    return res.status(_httpStatus2.default.BAD_REQUEST).json(e);\n  }\n}\n\nasync function getEventsList(req, res) {\n  const skip = parseInt(req.query.skip, 0);\n  const limit = parseInt(req.query.limit, 0);\n  try {\n    const events = await _event2.default.eventsList({ skip, limit });\n    return res.status(_httpStatus2.default.OK).json(events);\n  } catch (e) {\n    return res.status(_httpStatus2.default.BAD_REQUEST).json(e);\n  }\n}\n\nasync function deleteEvent(req, res) {\n  try {\n    const event = await _event2.default.findById(req.params.id);\n    if (!event.user.equals(req.user._id)) {\n      return res.sendStatus(_httpStatus2.default.UNAUTHORIZED);\n    }\n    await event.remove();\n    return res.sendStatus(_httpStatus2.default.OK);\n  } catch (e) {\n    return res.status(_httpStatus2.default.BAD_REQUEST).json(e);\n  }\n}\n\n//# sourceURL=webpack:///./src/modules/events/event.controllers.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.addPhoto = addPhoto;\nexports.getPhotoById = getPhotoById;\nexports.getPhotosList = getPhotosList;\nexports.updatePhoto = updatePhoto;\nexports.deletePhoto = deletePhoto;\n\nvar _httpStatus = __webpack_require__(/*! http-status */ \"http-status\");\n\nvar _httpStatus2 = _interopRequireDefault(_httpStatus);\n\nvar _photo = __webpack_require__(/*! ./photo.model */ \"./src/modules/photos/photo.model.js\");\n\nvar _photo2 = _interopRequireDefault(_photo);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nasync function addPhoto(req, res) {\n  try {\n    const photoObject = {\n      'photo.data': req.file.path,\n      'photo.contentType': req.file.mimetype,\n      caption: req.body.caption };\n\n    const photo = await _photo2.default.addPhoto(photoObject, req.user._id);\n    return res.status(_httpStatus2.default.CREATED).json(photo);\n  } catch (e) {\n    return res.status(_httpStatus2.default.BAD_REQUEST).json(e);\n  }\n}\n\nasync function getPhotoById(req, res) {\n  try {\n    const photo = await _photo2.default.findById(req.params.id).populate('user');\n    return res.status(_httpStatus2.default.OK).json(photo);\n  } catch (e) {\n    return res.status(_httpStatus2.default.BAD_REQUEST).json(e);\n  }\n}\n\nasync function getPhotosList(req, res) {\n  const limit = parseInt(req.query.limit, 0);\n  const skip = parseInt(req.query.skip, 0);\n  try {\n    const photos = await _photo2.default.photosList({ limit, skip });\n    return res.status(_httpStatus2.default.OK).json(photos);\n  } catch (e) {\n    return res.status(_httpStatus2.default.BAD_REQUEST).json(e);\n  }\n}\n\nasync function updatePhoto(req, res) {\n  try {\n    const photo = await _photo2.default.findById(req.params.id);\n    if (!photo.user.equals(req.user._id)) {\n      return res.sendStatus(_httpStatus2.default.UNAUTHORIZED);\n    }\n    Object.keys(req.body).forEach(key => {\n      photo[key] = req.body[key];\n    });\n    if (req.file) {\n      photo.photo.contentType = req.file.mimetype;\n      photo.photo.data = req.file.path;\n    }\n    return res.status(_httpStatus2.default.OK).json((await photo.save()));\n  } catch (e) {\n    return res.status(_httpStatus2.default.BAD_REQUEST).json(e);\n  }\n}\n\nasync function deletePhoto(req, res) {\n  try {\n    const photo = await _photo2.default.findById(req.params.id);\n    if (!photo.user.equals(req.user._id)) {\n      return res.sendStatus(_httpStatus2.default.UNAUTHORIZED);\n    }\n    await photo.remove();\n    return res.sendStatus(_httpStatus2.default.OK);\n  } catch (e) {\n    return res.status(_httpStatus2.default.BAD_REQUEST).json(e);\n  }\n}\n\n//# sourceURL=webpack:///./src/modules/photos/photo.controllers.js?");

/***/ }),

/***/ "./src/modules/photos/photo.model.js":
/*!*******************************************!*\
  !*** ./src/modules/photos/photo.model.js ***!
  \*******************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _mongoose = __webpack_require__(/*! mongoose */ \"mongoose\");\n\nvar _mongoose2 = _interopRequireDefault(_mongoose);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nconst PhotoSchema = new _mongoose.Schema({\n  photo: {\n    data: Buffer,\n    contentType: String\n  },\n  caption: {\n    type: String,\n    trim: true,\n    minlength: [5, 'Caption need to be longer!']\n  },\n  user: {\n    type: _mongoose.Schema.Types.ObjectId,\n    ref: 'User'\n  }\n}, { timestamps: true });\n\nPhotoSchema.methods = {\n  toJSON() {\n    return {\n      _id: this._id,\n      photo: this.photo,\n      caption: this.caption,\n      user: this.user\n    };\n  }\n};\n\nPhotoSchema.statics = {\n  addPhoto(photo, user) {\n    return this.create(Object.assign({}, photo, {\n      user\n    }));\n  },\n  photosList({ skip = 0, limit = 0 } = {}) {\n    return this.find().sort().limit(limit).skip(skip).populate('user');\n  }\n};\n\nexports.default = _mongoose2.default.model('Photo', PhotoSchema);\n\n//# sourceURL=webpack:///./src/modules/photos/photo.model.js?");

/***/ }),

/***/ "./src/modules/photos/photo.routes.js":
/*!********************************************!*\
  !*** ./src/modules/photos/photo.routes.js ***!
  \********************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _express = __webpack_require__(/*! express */ \"express\");\n\nvar _expressValidation = __webpack_require__(/*! express-validation */ \"express-validation\");\n\nvar _expressValidation2 = _interopRequireDefault(_expressValidation);\n\nvar _photo = __webpack_require__(/*! ./photo.controllers */ \"./src/modules/photos/photo.controllers.js\");\n\nvar photoController = _interopRequireWildcard(_photo);\n\nvar _photo2 = __webpack_require__(/*! ./photo.validations */ \"./src/modules/photos/photo.validations.js\");\n\nvar _photo3 = _interopRequireDefault(_photo2);\n\nvar _jwt = __webpack_require__(/*! ../../services/jwt.services */ \"./src/services/jwt.services.js\");\n\nvar _multer = __webpack_require__(/*! ../../services/multer.services */ \"./src/services/multer.services.js\");\n\nfunction _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nconst routes = new _express.Router();\n\nroutes.post('/', _jwt.authJwt, _multer.mult, (0, _expressValidation2.default)(_photo3.default.addPhoto), photoController.addPhoto);\nroutes.get('/:id', _jwt.authJwt, photoController.getPhotoById);\nroutes.get('/', _jwt.authJwt, photoController.getPhotosList);\nroutes.patch('/:id', _jwt.authJwt, _multer.mult, photoController.updatePhoto);\nroutes.delete('/:id', _jwt.authJwt, photoController.deletePhoto);\n\nexports.default = routes;\n\n//# sourceURL=webpack:///./src/modules/photos/photo.routes.js?");

/***/ }),

/***/ "./src/modules/photos/photo.validations.js":
/*!*************************************************!*\
  !*** ./src/modules/photos/photo.validations.js ***!
  \*************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _joi = __webpack_require__(/*! joi */ \"joi\");\n\nvar _joi2 = _interopRequireDefault(_joi);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nexports.default = {\n  addPhoto: {\n    body: {\n      caption: _joi2.default.string().min(5).max(200)\n    },\n    file: {\n      photo: _joi2.default.string().required()\n    }\n  },\n  updatePhoto: {\n    body: {\n      caption: _joi2.default.string().min(5).max(200)\n    },\n    file: {\n      photo: _joi2.default.string()\n    }\n  }\n};\n\n//# sourceURL=webpack:///./src/modules/photos/photo.validations.js?");
...
/***/ "./src/services/multer.services.js":
/*!*****************************************!*\
  !*** ./src/services/multer.services.js ***!
  \*****************************************/
/*! no static exports found */
